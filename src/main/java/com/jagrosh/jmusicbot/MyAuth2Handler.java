...
public class MyAuth2Handler extends YoutubeOauth2Handler {

    private static final Logger log = LoggerFactory.getLogger(dev.lavalink.youtube.http.YoutubeOauth2Handler.class);
    ...
    public MyAuth2Handler(HttpInterfaceManager httpInterfaceManager, String googleClientId, String googleClientSecret) {
        super(null);
    ...
    private void pollForToken(String deviceCode, long interval) {
        ...
        String requestJson = JsonWriter.string()
                .object()
                .value("client_id", this.clientId)
                .value("client_secret", this.clientSecret)
